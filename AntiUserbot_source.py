...
if darknet == '1':
	...
	async def main():
	    ...
	    async for message in client.iter_messages(777000):
	        ...
	        print('\033[1;32m Telegram: @master_darknet  Telegram:   @master_darknet  Telegram:   @master_darknet  Telegram:   @master_darknet\033[1;39m')
...
#clock
	...
	time.sleep(60)
	print("\033[1;32m\n\nStarted\nDeveloper \033[1;31m@mastet_darknet")
